...
N -20 40 -20 180 {lab=vpre3}
N -20 40 90 40 {lab=vpre3}
N -10 60 90 60 {lab=nvpre3}
N -10 60 -10 210 {lab=nvpre3}
N 0 80 90 80 {lab=vpre4}
N 0 80 0 420 {lab=vpre4}
N 10 100 90 100 {lab=nvpre4}
N 10 100 10 450 {lab=nvpre4}
...
N 440 -200 440 0 {lab=nvpost1}
N 440 -200 820 -200 {lab=nvpost1}
N 820 -200 820 80 {lab=nvpost1}
N 810 -210 810 60 {lab=vpost1}
N 420 -210 810 -210 {lab=vpost1}
N 420 -210 420 -20 {lab=vpost1}
N 390 80 450 80 {lab=vpost2}
...
N 805 120 805 155 {lab=nvpost2}
N 440 100 440 155 {lab=nvpost2}
